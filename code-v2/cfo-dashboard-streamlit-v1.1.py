...
# Income vs Expenses
fig_income_expenses = px.line(filtered_df, x='Date', y=['Income', 'Expenses'],
                              title='Income vs Expenses')
col1.plotly_chart(fig_income_expenses, use_container_width=True)

# Bank Balance Trend
fig_bank_balance = px.line(filtered_df, x='Date', y='Bank_Balance',
                           title='Bank Balance Trend')
col2.plotly_chart(fig_bank_balance, use_container_width=True)
...
# Slider for historical data view
